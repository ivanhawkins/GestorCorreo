        ...
        return (
            <div className="app">
                <header className="app-header">
                    <h1>📧 Hawkins Mail <span style={{ fontSize: '0.7rem', color: '#aaa', fontWeight: 'normal' }}>v.03</span></h1>
            ...
            <aside className="sidebar">
                <div className="sidebar-header">
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                        <h2>📧 Hawkins <span style={{ fontSize: '0.6rem', color: '#aaa', fontWeight: 'normal', verticalAlign: 'middle' }}>v.03</span></h2>
